...
public class WxUtil {
	public static String WX_TOKEN = "wxToken"+PropertiesUtil.getValue("wx", "appid"); // 微信端的token key
	...
	private static final String LOCAL_TOKEN = PropertiesUtil.getValue("wx", "local_token"); // 配置到配置文件
